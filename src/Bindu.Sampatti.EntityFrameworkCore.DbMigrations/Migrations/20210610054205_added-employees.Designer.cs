...
namespace Bindu.Sampatti.Migrations
{
    ...
    [Migration("20210610054205_added-employees")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bindu.Sampatti.Departments.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Bindu.Sampatti.Employees.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Bindu.Sampatti.Plants.Plant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Bindu.Sampatti.Depots.Depot", b =>
                {
                    b.HasOne("Bindu.Sampatti.Locations.Location", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Bindu.Sampatti.Employees.Employee", b =>
                {
                    b.HasOne("Bindu.Sampatti.Departments.Department", null)
                        .WithMany()
                        .HasForeignKey("Department")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Bindu.Sampatti.Designations.Designation", null)
                        .WithMany()
