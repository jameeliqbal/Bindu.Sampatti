...
namespace Bindu.Sampatti.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update SampattiDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update SampattiEfCoreEntityExtensionMappings to extend the IdentityUser entity
